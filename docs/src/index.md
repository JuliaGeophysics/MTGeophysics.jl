...
- **2-D forward modelling** — TE/TM finite-difference (box integration) solver on tensor meshes, file-driven workflows, model/data I/O, misfit metrics, and pseudo-section/curve plotting.
- **2-D Gauss-Newton inversion** — damped log-resistivity inversion with implicit Fréchet derivatives, data weighting, smoothness regularization, bounds, and line search. See [Gauss-Newton inversion](gaussnewton2d.md).
