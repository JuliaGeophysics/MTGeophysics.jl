# Example: interactive XZ cross-section viewer for a ModEM model.
# Author: @pankajkmishra
# This script loads a model, builds 2D XZ cross-sections (slicing along the Y axis),
# and provides controls for browsing/export.
# Use it for fast inspection of model structure along the Y direction.
#
...
#   julia --project=. examples/plot_model_XZ_slices.jl <model_file> [data_file] [coordinate_system]
#   julia --project=. examples/plot_model_XZ_slices.jl <model_file> model
# Example (Cascadia):
#   julia --project=. examples/plot_model_XZ_slices.jl examples/cascadia/cascad_half_inverse.ws examples/cascadia/cascad_errfl5.dat EPSG:32610
...
function _print_cli_usage()
    println("Usage:")
    println("  julia --project=. examples/plot_model_XZ_slices.jl <model_file> [data_file] [coordinate_system]")
    println("  julia --project=. examples/plot_model_XZ_slices.jl <model_file> model")
    println("Example (Cascadia):")
    println("  julia --project=. examples/plot_model_XZ_slices.jl examples/cascadia/cascad_half_inverse.ws examples/cascadia/cascad_errfl5.dat EPSG:32610")
end
...
max_depth         = 200000          # Maximum depth (m) to visualise (default 50 km)
...
function main()
    ...
    M_crs, horiz_label, slider_label, slider_unit = _build_xz_model_in_crs(M, d, coordinate_system)
