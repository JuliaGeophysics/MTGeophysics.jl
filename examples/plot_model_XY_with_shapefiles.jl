# Example: interactive depth-slice (XY) viewer for a ModEM model with shapefile overlays.
# Author: @pankajkmishra
# This script is the shapefile-overlay variant of plot_model_XY_slices.jl: it loads a
# model, builds 2D map slices by depth, and overlays any number of shapefiles
