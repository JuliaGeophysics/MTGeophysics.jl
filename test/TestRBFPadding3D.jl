# 3D VFSA padding blends and RBF widths
# Author: @pankajkmishra
# Ensures the padding blend keeps frozen sources out of the padding, carries the core bottom down a third per layer,
# measures distance physically and ignores single wild edge cells, and that RBF widths scale with depth
