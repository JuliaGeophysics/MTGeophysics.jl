# 2D benchmark models and cases
# Author: @pankajkmishra
# Ensures the COMEMI models put the right resistivity inside each anomaly and host, and that SaveBenchmarks2D
# writes a complete, consistent case (true, start and prior models, data, cov.ctrl, mask.ctrl) on the Jyväskylä line
...
@testset "2D benchmarks" begin
    @testset "COMEMI model geometry" begin
    ...
    @testset "benchmark case files" begin
        mktempdir() do temp_dir
            ...
            @test observed.site_names[1] == "TK01" && issorted(observed.longitudes)
